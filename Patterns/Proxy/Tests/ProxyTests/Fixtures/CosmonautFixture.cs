...
namespace ProxyTests.Fixtures
{
  public class CosmonautFixture : IDisposable
  {
    ...
    public readonly string sut_SpeakExpected = FactoryConstants.CSM_SPK;

    public readonly string sut_LaunchExpected = FactoryConstants.CSM_LAUNCH;
