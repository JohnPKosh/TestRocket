namespace alterstate.Models2
{
  ...
  public abstract class ProcessState
  {
    ...
    public virtual void Initialize(ProcessContext context) => m_Context.CurrentState = new InitializedState(context);
  ...
  /// <summary>
  /// The concrete uninitialized state that inherits from ProcessState.
  /// </summary>
  public class UninitializedState : ProcessState
  {
    public UninitializedState(ProcessContext context) : base(context) { }
  }


  /// <summary>
  /// The concrete initialized state that inherits from ProcessState.
  /// </summary>
  public class InitializedState : ProcessState
  {
    public InitializedState(ProcessContext context) : base(context) { }
  }


  /// <summary>
  /// The concrete failed state that inherits from ProcessState.
  /// </summary>
  public class FailedState : ProcessState
  {
    public FailedState(ProcessContext context) : base(context) { }
  }
