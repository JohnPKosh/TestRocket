...
namespace MongoIdent.Areas.Identity.Pages.Account
{
  [AllowAnonymous]
  public class RegisterModel : PageModel
  {
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
      ...
      {
        Guid? teamKey = null;
        if (!string.IsNullOrWhiteSpace(Input.TeamKey) && Guid.TryParse(Input.TeamKey, out Guid parsedKey))
        {
          // TODO: Add validation of TeamKey against active registered "Team Accounts" !!!!!!!!!!!!!!!!!!
          teamKey = parsedKey;
        }
